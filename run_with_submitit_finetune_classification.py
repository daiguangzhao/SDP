...
def parse_args():
    ...
    parser.add_argument("--timeout", default=288000000000000000000, type=int, help="Duration of the job")
...
def get_shared_folder() -> Path:
    # user = os.getenv("USER")
    # print("user", user)
    if Path("/opt/data/private/project/LaViLa-main").is_dir():
        # p = Path(f"/checkpoint/{user}/experiments/lavila_ft")
        p = Path(f"/opt/data/private/project/LaViLa-main/checkpoint/experiments/lavila_ft")
