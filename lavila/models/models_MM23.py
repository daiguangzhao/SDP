...
def TIMESFORMER_BASE(
    img_size=224, patch_size=16, num_frames=8, attention_type='divided_space_time', **kwargs):
...
def CLIP_OPENAI_TIMESFORMER_BASE(
    ...
    temperature_init=0.07, project_embed_dim=256, sfa_layer=1, num_part=9, d2_sfc=False, **kwargs,
):
