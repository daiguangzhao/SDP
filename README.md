...
python run_with_submitit_finetune_classification.py \
    --pretrain-model p<a href="https://dl.fbaipublicfiles.com/lavila/checkpoints/dual_encoders/ego4d/clip_openai_timesformer_base.narrator_rephraser.ep_0005.md5sum_d73a9c.pth" target="_blank">lavila/datasets/README.md</a>/clip_openai_timesformer_base.narrator_rephraser.ep_0005.md5sum_d73a9c.pth \
    --use-vn-classifier \
